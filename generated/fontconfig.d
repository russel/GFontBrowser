...
FcBool FcConfigFileInfoIterGet (
    FcConfig* config,
...
FcResult FcPatternGetWithBinding (
    const(FcPattern)* p,
    const(char)* object,
    int id,
    FcValue* v,
...
int FcUcs4ToUtf8 (FcChar32 ucs4, ref FcChar8[FC_UTF8_MAX_LEN] dest);
